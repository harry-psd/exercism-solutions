...
def exchange_money(budget, exchange_rate):
    ...
    """
    estimated_value_after_exchange = budget / exchange_rate
    return estimated_value_after_exchange
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    total_value = exchange_money(budget, exchange_rate)
    no_of_notes =  int(total_value // denomination)
    return no_of_notes * denomination
